...
df = pd.DataFrame(
    {
        ...
        "Transfer_Learning": [
            float(classified_metric_nodebiasing_test_TF["Classification_accuracy"]),
            float(
                classified_metric_nodebiasing_test_TF[
                    "Balanced_classification_accuracy"
                ]
            ),
            float(
                classified_metric_nodebiasing_test_TF["Statistical_parity_difference"]
            ),
            float(classified_metric_nodebiasing_test_TF["Disparate_impact"]),
            float(
                classified_metric_nodebiasing_test_TF["Equal_opportunity_difference"]
            ),
            ...
            float(
                classified_metric_nodebiasing_test_TF["False_negative_rate_difference"]
            ),
        ],
    }
)
...
df1 = pd.DataFrame(
    {
        ...
        "Transfer_Learning": [
            float(classified_metric_debiasing_test_TF["Classification_accuracy"]),
            float(
                classified_metric_debiasing_test_TF["Balanced_classification_accuracy"]
            ),
            ...
            float(
                classified_metric_debiasing_test_TF["False_negative_rate_difference"]
            ),
        ],
        "Transfer_Learning_Adv": [
            float(classified_metric_debiasing_test_TF_Ad["Classification_accuracy"]),
            float(
                classified_metric_debiasing_test_TF_Ad[
                    "Balanced_classification_accuracy"
                ]
            ),
            float(
                classified_metric_debiasing_test_TF_Ad["Statistical_parity_difference"]
            ),
            float(
                classified_metric_debiasing_test_TF_Ad["Equal_opportunity_difference"]
            ),
            ...
            float(
                classified_metric_debiasing_test_TF_Ad["False_negative_rate_difference"]
            ),
        ],
    }
)

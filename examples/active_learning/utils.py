...
def get_trained_net(name, device, path):
    if name == "MNIST":
        return Net(MNIST_Net, params[name], device, path)
    elif name == "FashionMNIST":
        return Net(MNIST_Net, params[name], device, path)
    elif name == "SVHN":
        return Net(SVHN_Net, params[name], device, path)
    elif name == "CIFAR10":
        return Net(CIFAR10_Net, params[name], device, path)
    else:
        raise NotImplementedError

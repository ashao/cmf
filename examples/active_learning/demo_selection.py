...
parser.add_argument(
    "--trained_model", type=str, default="model", help="path of trained model"
)
parser.add_argument(
    "--dataset_name",
    type=str,
...
parser.add_argument(
    "--df_pipeline_name",
    type=str,
    default="active-learning-single-strategy",
...
if args.enable_df is True:
    ...
    cumulative_scores = torch.add(
        scores[1], scores_df[1], alpha=args.df_strategy_weight
    )
